      ...
      <div class="content">
		...
		<form action="" method="post">
            <div class="card">
			 ...
			 {
				 echo"<h4>Klassennamen von ".$row[0]." ändern</h4>";
			 }
		 ...
		 <?php
		  ...
		  if(isset($_POST['newklassenname'])) 
	{
			$statement = $pdo->prepare("UPDATE klassen SET klassen_bezeichnung ='".$_POST['newklassenname']."' WHERE id=$id");
			$result = $statement->execute();
			$row = $statement->fetch();
			
			echo '<meta http-equiv="refresh" content="0; URL=./classes.php?state=3">';	
	}
		 ?>
