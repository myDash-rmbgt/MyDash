      ...
      <div class="content">
		...
		<form action="" method="post">
            <div class="card">
			 ...
			 {
				 echo"<h4>Schüler zur Klasse ".$row[0]." hinzufügen</h4>";
				 $klassennamen=$row[0];
			 }
...
<h1>Anmeldedaten für '.$klassennamen.'</h1>
 
<p>Sie haben weitere Schüler der Klasse '.$klassennamen.' hinzugefügt. Geben Sie den entsprechenden Schülern jeweils einen Einmalkey und Einmalpass.</p>
			...
			while($i<($schueleranzahl+1))
				{
					...
					$statement = $pdo->prepare("INSERT INTO users (einmalkey, einmalpass, klassen_id) VALUES ('$einmalkey', '$einmalpass', '$id')");
					$result = $statement->execute();	
					$statement->fetch();
					$i=$i+1;
				}
...
$betreff    = "Anmeldedaten für neue Schüler Ihrer Klasse";
...
mail( $empfaenger,
	...
	echo '<meta http-equiv="refresh" content="0; URL=./classes.php?state=7">';	
	}
		 ?>
